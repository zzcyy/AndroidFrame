package com.creatunion.demo.videoplayer;
...
import com.creatunion.demo.videoplayer.view.JCVideoPlayerStandardShowShareButtonAfterFullscreen;
import com.creatunion.demo.videoplayer.view.JCVideoPlayerStandardShowTitleAfterFullscreen;
        ...
        switch (v.getId()) {
            case R.id.to_fullscreen_simple:
                JCFullScreenActivity.startActivity(this,
                        ...
                        JCVideoPlayerSimple.class, "真浪");
                break;
            case R.id.to_fullscreen_standard:
                JCFullScreenActivity.startActivity(this,
                        "http://2449.vod.myqcloud.com/2449_22ca37a6ea9011e5acaaf51d105342e3.f20.mp4",
                        JCVideoPlayerStandard.class, "真牛逼");
                break;
            case R.id.to_list_activity:
                startActivity(new Intent(VideoMainActivity.this, ListActivity.class));
                break;
            case R.id.to_list_viewpager_activity:
                startActivity(new Intent(VideoMainActivity.this, ListViewpagerActivity.class));
                break;
            case R.id.to_multiholder_activity:
                startActivity(new Intent(VideoMainActivity.this, MultiHolderActivity.class));
                break;
            case R.id.to_loadimage_activity:
                startActivity(new Intent(VideoMainActivity.this, LoadImageActivity.class));
                break;
        }
    }
